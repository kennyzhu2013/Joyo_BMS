...
<block name="main">
    <div class="well-main layui-form">
        <div class="well-editor" style="">
            <input type="text" id="title" name="title" required  lay-verify="required" placeholder="   请输入标题" autocomplete="off" class="layui-input well-title-input" value="{$article.title}">
        ...
        <div class="well-ctl">
            ...
            <div class="layui-collapse">
              <div class="layui-colla-item">
                ...
                <div class="layui-colla-content layui-show">
                    <input id="modifyArticle" type="button" class="layui-btn" value="Submit">
